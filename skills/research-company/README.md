...
| [`references/industry-primers/`](references/industry-primers/) | Canonical industry shorthand — regulator IDs, entity kinds, workflow names, KPI sets — per vertical. **Canon** ([AGENTS.md § 2.2](../../AGENTS.md)) — do not normalize. |
...
the public catalog. See [AGENTS.md § 2.1 — Skills are agnostic](../../AGENTS.md#21-skills-are-agnostic).
